        ...
        <>
            ...
            <div className="profile-container">
                <Navbar className="navBar-bg" expand={false} fixed="top">
                    <Container fluid>
                        <Navbar.Brand  href="#"><p className="heading">Akash Kumar</p></Navbar.Brand>
                        ...
                        >
                            ...
                            <Offcanvas.Body>
                                <Nav>
                                    <Nav.Link ><p className="menu-content">HOME</p></Nav.Link>
                                    <Nav.Link ><p className="menu-content" >ABOUT</p></Nav.Link>  
                                    <Nav.Link ><p className="menu-content">RESUME</p></Nav.Link> 
                                    <Nav.Link ><p className="menu-content">PROJECTS</p></Nav.Link> 
                                    <Nav.Link ><p className="menu-content">CONTACT</p></Nav.Link>                                 
                                </Nav>
                            </Offcanvas.Body> 
                        </Navbar.Offcanvas>
                    </Container>
